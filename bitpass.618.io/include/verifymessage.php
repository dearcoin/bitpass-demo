...
function isMessageSignatureValid($address, $signature, $message) {
	...
	$secp256k1 == null && $secp256k1 = new CurveFp(
			'0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFC2F', '0', '7');
	$secp256k1_G == null && $secp256k1_G = new Point($secp256k1,
...
function recoverPubKey($r, $s, $e, $recoveryFlags, $G) {
	...
	static $p_over_four = null; // XXX just assuming only one curve/prime will be used
	if (!$p_over_four) {
